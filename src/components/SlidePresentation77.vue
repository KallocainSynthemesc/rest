<template>
  <div class="slide">
    ...
    <div class="content">
      <p>J'ai déjà annoté la classe Personne et je l'ai convertie en XML</p>
      <div
        style="
          background: #ffffff;
          overflow: auto;
...
<span style="color: #333333">}</span>
      ...
      <br />
      <h3>
        Exercice: Pouvez-vous annoter la classe BankAccount et imprimer une
        instance sur la console ?
      </h3>
      <br />
      <a
