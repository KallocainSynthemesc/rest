<template>
  <div class="slide">
    <div class="heading">RESTful - JAX RS</div>
    <div class="content">
      <div class="flex-container">
        <div style="width: 80%">
          <h2>Conversion des types primitifs</h2>
          <br />
          <p>
            Nous avons déjà vu quelques exemples de conversion automatique d'une
            chaîne de caractères en un type primitif
          </p>
          <br />
          <div
            style="
...
<span style="color: #008800; font-weight: bold">public</span> String <span style="color: #0066BB; font-weight: bold">get</span><span style="color: #333333">(</span><span style="color: #555555; font-weight: bold">@PathParam</span><span style="color: #333333">(</span><span style="background-color: #fff0f0">&quot;id&quot;</span><span style="color: #333333">)</span> <span style="color: #333399; font-weight: bold">int</span> id<span style="color: #333333">)</span> <span style="color: #333333">{...}</span></pre>
          </div>
        </div>
        <div style="width: 11%">
          <img
            src="../assets/illustrations/caveman-axe-torch.svg"
            style="width: 100%"
          />
        </div>
      </div>
